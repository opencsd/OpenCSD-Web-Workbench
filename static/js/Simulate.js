document.addEventListener("DOMContentLoaded", function () {
    ...
    document.getElementById("pushdownButton").addEventListener("click", function () {
        ...
        if (queryText) {
            ...
            const Exesutiongraph2 = document.createElement("td");
            ...
            const graphBar5 = document.createElement("div");
            ...
            Exesutiongraph2.appendChild(graphBar5);
            ...
            newRow.appendChild(Exesutiongraph2);
